...
@Service
@AllArgsConstructor
public class IListCardIncomeLessThanEqualUseCase implements IListCardDomainIncomeLessThanEqualRepository {
    ...
    public List<CardDomain> execute(BigDecimal income){
        return (List<CardDomain>) converterDTO
                .convertListObjects(this.cardRepository.findByIncomeLessThanEqual(income), CardDomain.class);
    }
}
